//@author Jesus Tabares
	...
	*/
	...
	String R_AtLeastOneE = "(!r1.&!r2.&!r3.)&((!r1.&!r2.&!r3.)U(r1.|r2.|r3.))";//(!r1^!r2^!r3)^((!r1^!r2^!r3)U(r1|r2|r3))
	...
	*/
	...
	String L_ConsecutiveC = "(l1.&X(l2.&(&Xl3.)))";//(l1^X(l2^(^Xl3)))
	String P_ConsecutiveC = "(p1.&X(p2.&(&Xp3.)))";//(p1^X(p2^(^Xp3)))
	String Q_ConsecutiveC = "(q1.&X(q2.&(&Xq3.)))";//(q1^X(q2^(^Xq3)))
	String R_ConsecutiveC = "(r1.&X(r2.&(&Xr3.)))";//(r1^X(r2^(^Xr3)))
	...
	*/
	...
	String L_ConsecutiveE = "(!l1.&!l2.&!l3.)&((!l1.&!l2.&!l3.)U(l1.&!l2.&!l3.&X(l2.&!l3.&X(l2.&!l3.&Xl3.))))";
	//(!p1^!p2^!p3)^((!p1^!p2^!p3)U(p1^!p2^!p3^X(p2^!p3^X(p2^!p3^Xp3))))
	String P_ConsecutiveE = "(!p1.&!p2.&!p3.)&((!p1.&!p2.&!p3.)U(p1.&!p2.&!p3.&X(p2.&!p3.&X(p2.&!p3.&Xp3.))))";
	//(!q1^!q2^!q3)^((!q1^!q2^!q3)U(q1^!q2^!q3^X(q2^!q3^X(q2^!q3^Xq3))))
	String Q_ConsecutiveE = "(!q1.&!q2.&!q3.)&((!q1.&!q2.&!q3.)U(q1.&!q2.&!q3.&X(q2.&!q3.&X(q2.&!q3.&Xq3.))))";
	//(!r1^!r2^!r3)^((!r1^!r2^!r3)U(r1^!r2^!r3^X(r2^!r3^X(r2^!r3^Xr3))))
	String R_ConsecutiveE = "(!r1.&!r2.&!r3.)&((!r1.&!r2.&!r3.)U(r1.&!r2.&!r3.&X(r2.&!r3.&X(r2.&!r3.&Xr3.))))";
	...
	*/
	...
	String L_EventualC = "(l1.&X(!l2.U(l2.&X(!l2.U(!l3.Ul3.)))))";//(l1^X(!l2 U (l2 ^ X (!l2 U (!l3 U l3)))))	
	String P_EventualC = "(p1.&X(!p2.U(p2.&X(!p2.U(!p3.Up3.)))))";//(p1^X(!p2 U (p2 ^ X (!p2 U (!p3 U p3)))))
	String Q_EventualC = "(q1.&X(!q2.U(q2.&X(!q2.U(!q3.Uq3.)))))";//(q1^X(!q2 U (q2 ^ X (!q2 U (!q3 U q3)))))
	String R_EventualC = "(r1.&X(!r2.U(r2.&X(!r2.U(!r3.Ur3.)))))";//(r1^X(!r2 U (r2 ^ X (!r2 U (!r3 U r3)))))	
	...
	*/
	...
	String L_EventualE = "(!l1.^!l2.^!l3.)^((!l1.^!l2.^!l3.)U(l1.^!l2.^!l3.^((!l2.^!l3.)U(l2.^!l3.^(l2.^!^!l3.^(!l3.Ul3.))))))";
	
	//(!p1^!p2^!p3)^((!p1^!p2^!p3)U(p1^!p2^!p3^((!p2^!p3)U(p2^!p3^(p2^!^!p3^(!p3Up3))))))
	String P_EventualE = "(!p1.^!p2.^!p3.)^((!p1.^!p2.^!p3.)U(p1.^!p2.^!p3.^((!p2.^!p3.)U(p2.^!p3.^(p2.^!^!p3.^(!p3.Up3.))))))";

	//(!q1^!q2^!q3)^((!q1^!q2^!q3)U(q1^!q2^!q3^((!q2^!q3)U(q2^!q3^(q2^!^!q3^(!q3Uq3))))))
	String Q_EventuaqE = "(!q1.^!q2.^!q3.)^((!q1.^!q2.^!q3.)U(q1.^!q2.^!q3.^((!q2.^!q3.)U(q2.^!q3.^(q2.^!^!q3.^(!q3.Uq3.))))))";

	//(!r1^!r2^!r3)^((!r1^!r2^!r3)U(r1^!r2^!r3^((!r2^!r3)U(r2^!r3^(r2^!^!r3^(!r3Ur3))))))
	String R_EventuarE = "(!r1.^!r2.^!r3.)^((!r1.^!r2.^!r3.)U(r1.^!r2.^!r3.^((!r2.^!r3.)U(r2.^!r3.^(r2.^!^!r3.^(!r3.Ur3.))))))";
